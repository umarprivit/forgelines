        ...
        <div className="min-h-screen pt-24 pb-20 bg-slate-50">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">{content.about.header.title}</h1>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
                    <div className="space-y-6">
                        <h2 className="text-3xl font-bold text-slate-900">{content.about.bridging_gap.title}</h2>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-6 relative z-10">{content.about.model_works.title}</h3>
                ...
                <div className="mb-20">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">{content.about.manufacturer_reasons.title}</h2>
                        <p className="text-slate-600">{content.about.manufacturer_reasons.subtitle}</p>
                    </div>
                    <HoverEffect
                ...
                <div>
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">{content.about.buyer_reasons.title}</h2>
                        <p className="text-slate-600">{content.about.buyer_reasons.subtitle}</p>
                    </div>
                    <HoverEffect
                        items={buyerReasons}
